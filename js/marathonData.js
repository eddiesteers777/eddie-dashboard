...
export function getCompletedWorkouts(progress){
...
export function getAdjustedWeekDays(weekNumber, overridesArg){
...
export function getAdjustedWeekMileage(weekNumber, overridesArg){
