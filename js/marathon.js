...
/*
   This file is a plain classic script (no import/export).
   It depends on marathonData.js being loaded first via a
   normal <script src="js/marathonData.js"></script> tag —
   see marathon.html. That file's top-level consts/functions
   (WEEKS, PHASES, PACES, DAYS, DAY_TIMES, weekStart, weekEnd,
   weekRange, getPeakMileage, getAdjustedWeekDays,
   getAdjustedWeekMileage, loadProgress, saveProgress,
   loadOverrides, saveOverrides) are used directly below.
*/
