...
const trapEl = document.getElementById("contactCompany");
...
form.addEventListener("submit", async event => {
    ...
    // A bot filled the hidden field: act like it worked, save nothing.
    if (trapEl.value) {
        form.hidden = true;
    ...
    try {
        ...
        showMsg("Couldn't send your question. Check your connection and try again.");
