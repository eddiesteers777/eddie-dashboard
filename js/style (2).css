...
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Bebas+Neue&family=JetBrains+Mono:wght@400;500;700&display=swap');
...
body{
    ...
    background:
        radial-gradient(circle at top,#182B45 0%,#0B1526 45%,#050A12 100%);
...
#logoutBtn:hover{
    ...
    box-shadow:0 10px 25px rgba(78,168,255,.35);
...
.primary-btn:hover{
    ...
    box-shadow:0 18px 40px rgba(78,168,255,.40);
...
.goal-card:hover{
    ...
    box-shadow:0 38px 80px rgba(37,99,235,.45);
...
.coach-button{
    ...
    box-shadow:0 16px 40px rgba(78,168,255,.30);
...
.coach-button:hover{
    ...
    box-shadow:0 22px 50px rgba(78,168,255,.40);
...
.card:hover .card-icon{
    ...
    box-shadow:0 12px 30px rgba(78,168,255,.22);
